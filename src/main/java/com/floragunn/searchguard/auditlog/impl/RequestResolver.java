...
public class RequestResolver {
    ...
    public static void resolve(final ContextAndHeaderHolder request, final Map<String, Object> auditInfo,
    ...
    private static void resolveInner(final String postfix, final Object request, final Map<String, Object> auditInfo,
        ...
        if (request instanceof MultiGetRequest.Item) {
            ...
            addIndicesSourceSafe(postfix, auditInfo, indices, resolver, cs, sr.source() == null? sr.extraSource(): sr.source(), settings, false);
    ...
    private static void addIndicesSourceSafe(final String postfix, final Map<String, Object> auditInfo, 
        ...
        final String[] resolvedIndices = (resolver==null)?new String[0]:resolver.concreteIndices(cs.get().state(), IndicesOptions.lenientExpandOpen(), indices);
